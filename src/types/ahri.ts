...
export type AhriPersonality = 'professional' | 'concise' | 'warm' | 'executive';
export type FridayPersonality = AhriPersonality; // Backward compatibility alias
